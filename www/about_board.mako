        ...
        <br>
            <div class="col-md-12 col-sm-12">
                <div class="content-page">
                    <div><h2> This is the Advisory Board for the Center for Open Science. The Center for Open Science board is diverse in background and skills.</h2></div>
                    <hr>
                    <br>
                    ...
                    <div class="row margin-bottom-30">
                        ...
                        <div class="col-md-7">
                            ...
                            <p>He is an active member of the broader digital library and digital humanities communities, serving on a number of advisory boards and program committees, and maintains active research and teaching interests in the history and sociology of information technology, the dynamics of public engagement with expert knowledge, and the methodological implications of new digital technologies for research.
                            He has broad experience and understanding of the content and research needs of traditional scholarly communities as well as digitally-networked services and tools to support myriad forms of public engagement and participation.</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row margin-bottom-30">
                    ...
                    <div class="row margin-bottom-30">
                        ...
                        <div class="col-md-7">
                            ...
                            <p>Victoria is an assistant professor of Statistics at Columbia University, and affiliated with the Columbia University Institute for Data Sciences and Engineering. She completed her PhD in statistics and her law degree at Stanford University.</p>
                            ...
                            <p>She is the founder of the open source platform ResearchCompendia.org, designed as a pilot project to study the verification of code and data associated with published results, and enable independent and public cloud-based validation of methods and findings. She is also a co-founder of RunMyCode.org, an open platform connecting data and code to published articles.</p>
                            <p>Victoria was awarded the NSF EAGER grant "Policy Design for Reproducibility and Data Sharing in Computational Science."</p>
                            <p>She co-chairs the NSF Advisory Committee for CyberInfrastructure, and is a member of the NSF's Computer and Information Science and Engineering (CISE) Advisory Committee. She is also a member of the NIH National Library of Medicine's PubMed Central National Advisory Committee.</p>
                            <p>Victoria serves on the NSF Mathematics and Physical Sciences Directorate Subcommittee on "Support for the Statistical Sciences at NSF," and the National Academies of Science committee on "Responsible Science: Ensuring the Integrity of the Research Process." She also serves on several committees in the American Statistical Association: The Committee on Privacy and Confidentiality, the Committee on Data Sharing and Reproducibility, and the Presidential Strategic Initiative, Developing a Prototype Statistics Portal. She also serves on the Columbia University's Senate Information Technologies Committee.</p>
                            <p>She testified before the Congressional House Science, Space, and Technology Committee on Scientific Transparency and Integrity on March 5, 2013.
                            ...
                            She is also the creator and curator of SparseLab, a collaborative platform for reproducible computational research in underdetermined systems.</p>
