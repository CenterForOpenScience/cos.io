...
<div class="container min-hight margin-bottom-100 margin-top-50">
        ...
        <p>Visit the <a href="http://openscienceframework.org/project/4znZP/wiki/home">OSF features page</a>, watch the <a href="https://osf.io/getting-started/">getting started videos</a>, or sign-up and begin using the OSF. You can also talk to a <a href="mailto:contact@cos.io">human</a>.</p>
        <h3>Reproducibility Projects</h3>
        <p>Reproducibility of published results is a key component to scientific progress. Do current scientific practices and incentive structures hinder this process? COS Reproducibility Projects are open collaborations to independently replicate key results, with the aim of better understanding the barriers and incentives involved in reproducible research.  <a href=" https://osf.io/ezcuj/wiki/home/">Reproducibility Project: Psychology</a> focuses on three prominent psychology journals, while <a href="https://osf.io/e81xl/wiki/home/">Reproducibility Project: Cancer Biology</a> focuses on 50 landmark cancer biology studies.</p>
