        ...
        <div class="row">
            <div class="col-sm-2 community-tab-list">
                <ul class="tabbable community-tabbable change-url-tabbable" id="">
                    ...
                    <li><a id="tab-5" href="#list" data-toggle="tab">805 Signatories</a></li>
          ...
          ##  <div class="col-sm-9 col-sm-offset-1 ">
            ...
            <!-- START TAB CONTENT -->
                <div class="tab-content">
                                  ...
                                  ##  <p style="text-align:justify">Transparency, open sharing, and reproducibility are core values of science, but not always part of daily practice. Journals, funders, and scholarly societies can increase the transparency and reproducibility of research by adopting the TOP Guidelines.
                                      ...
                                      <p>
                                        <ul>
                                          ...
                                          <li><a data-tab-destination="tab-3">Follow these steps</a> to implement TOP at your journal or agency and request custom guidelines for your organization <a target="_blank" href="https://goo.gl/forms/onWTLhg8sCkqd42n1">here</a>.</li>
                    ...
                    <div style="height: 200px;">&nbsp;</div>
                      <center><h3>Eight Standards at Three Levels</h3>
                      <p>Decide which levels your orgnization would like to implement <a target="_blank" href="https://goo.gl/forms/onWTLhg8sCkqd42n1">
                        here</a>.</p></center>
                        <br>
                        ##  <table id="t01">
                        ...
                        <tr>
                            <td>
                              <h3>Implementing the TOP Guidelines</h3>
                                <ul>
                                    <li>Request custom guidelines for your organization <a target="_blank" href="https://goo.gl/forms/onWTLhg8sCkqd42n1">
                                    here</a>.</li>
                    ...
                    <p class="margin-top-20"><b>Journal signatories are:</b></p>
                                            ...
                                            <ol>
                                                ...
                                                <li>If relevant, encouraging associated journals to conduct a review of the standards and levels for potential adoption.</li>
                                                    ...
                                                    <br>
                        <li class="active"><a data-toggle="tab" href="#journals"><b>Journals (738)</b></a></li>
