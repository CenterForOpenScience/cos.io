...
<div class="row-fluid">
    <div class="span12">
        <div style="text-align: center;">
            ...
            <br>
            <p class="lead">When you share the COS mission through Giving Library</a>, the Center will receive a $5 donation of support. In <a href="https://github.com/gittip/www.gittip.com/issues/1892">collaboration with Gittip</a>, that $5 will be donated to OSS developers that are making a difference in the open source and open science communities. The COS, as part of its daily mission, is already one of Gittip's top donors, but we can do even more - <strong>possibly $62,000 more</strong>, but the pot goes away January 31, 2014!</p>
...
##     </div>
##     <br><br>
##     <div style="padding-left: 100px; padding-bottom: 125px" data-twttr-id="twttr-sandbox-0">
...
<ul class="breadcrumb">
    ...
    <li class="active">Giving Library</li>
</ul>
