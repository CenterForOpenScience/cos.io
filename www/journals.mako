...
<%def name="title()">Services for Journals and Societies</%def>
<%def name="description()">The Center for Open Science offers a variety of services for journals and societies to facilitate and incentivize open science.</%def>
<%def name="navigation()">
    ${self.navlinks('journals')}
</%def>
...
<div class="tab-pane" id="tab_3">
    ...
    <div class="col-md-8">
        <h4><strong>3. Increase your conference's reach with OSF for Meetings</strong></h4>
