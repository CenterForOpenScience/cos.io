                                    ...
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                      ...
                                      <div class="panel panel-default">
                                          <div class="panel-heading" role="tab" id="12">
                                              <h4 class="panel-title">
                                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" hdata-target="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve"><strong>12</strong> Registered Reports may become seen as the gold standard for scientific publishing, which would unfairly disadvantage exploratory or observational studies that cannot be pre-registered.</a>
                                              </h4>
                                          </div>
