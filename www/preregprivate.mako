                                      ...
                                      <h3>How to Earn the Prize</p></h3>
                                        ...
                                        <li>
                                          <strong>Write up your results</strong>
                                            <p>Report all of the preregistered analyses in your manuscript. Clearly distinguish preregistered analyses from additional exploratory analyses. Include a URL link to the study preregistration.</p>
                                        <li>
                                                      ...
                                                      <div class="panel-heading" role="tab" id="headingSeven">
                                                        ...
                                                        <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                                                          ...
                                                          <ul>
                                                            ...
                                                            <p>If the present preregistration process does not fit your research approach effectively, and you believe that there are ways to conduct preregistered research in your field, we encourage you to contact us to help develop and specify a preregistration process for your work (prereg@cos.io).  The Preregistration Challenge is both an educational effort to encourage preregistration, and a research effort to develop effective preregistration processes that cover the wide variety of research approaches in science.
                                                           </div>
                                                          </div>
                                                        </div>
                                                      <!-- End FAQ 7 -->
