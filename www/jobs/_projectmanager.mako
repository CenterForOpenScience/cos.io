...
<dl class="dl-horizontal">
    ...
    <dt>Responsibilities</dt>
        <dd>
            <p>The key responsibilities for the project manager include managing initiatives to improve scientific practices including badges for journals to acknowledge open practices (e.g., <a href="https://osf.io/tvyxz/">https://osf.io/tvyxz/</a>), a Registered Reports publishing format (e.g., <a href="https://osf.io/hxeza/">https://osf.io/hxeza/</a>), checklists for research workflow (e.g., <a href="https://osf.io/mv8pj/">https://osf.io/mv8pj/</a>), and disclosure standards (e.g., <a href="https://osf.io/hadz3/">https://osf.io/hadz3/</a>).  The project manager will foster and manage connections with the scientific community on these initiatives, provide training and support for users, maintain project documentation and standards, and track progress on project goals.</p>
        </dd>
    <dt>Skills</dt>
        <dd>
