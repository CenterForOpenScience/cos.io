        ...
        <div class="row">
            ...
            <div class="col-md-9 blog-item margin-bottom-40">
                ...
                <div style="padding-bottom: 50px;">
                    <br>
                    <p>May 19, 2014, Charlottesville, Virginia, USA. Journal articles are the currency of science, but
                        incentives favoring novelty over accuracy potentially undermine the credibility of the scientific
                        literature. A <a href="http://www.psycontent.com/content/1864-9335">
                            special issue of the journal Social Psychology</a></span><span>, published today, adopts a new Registered
                            Reports format as a way to shift the incentives and increase the credibility of published results.</p>
                    <p>Registered Reports emphasize the importance of the research question and the quality of methodology
                        by conducting the peer review prior to data collection and analysis. Accepted papers then are virtually
                        guaranteed publication in the journal if the authors follow through with the registered methodology.
                        “Registered reports eliminates the bias against negative results in publishing because the results
                        are not known at the time of review” said Daniel Simons, Professor at University of Illinois,
                        Urbana-Champaign and co-Editor of <a href="http://www.psychologicalscience.org/index.php/replication">
                            Registered Replication Reports</a> at Perspectives on Psychological
                        Science. Chris Chambers, Senior Research Fellow at Cardiff University, section editor at
                        <a href="http://cdn.elsevier.com/promis_misc/PROMISpub_idt_Guidelines_cortex_RR_17_04_2013.pdf">Cortex</a>
                        and <a href="http://www.aimspress.com/aimspress/ch/index.aspx">AIMS Neuroscience</a>, and chair
                        of the <a href="https://osf.io/8mpji/">Registered Reports Committee</a> supported by the <a href="https://cos.io">
                        Center for Open Science</a> (COS) adds, “Because the study is accepted in advance, the incentives for authors
                        change from producing the most beautiful story to producing the most accurate one.”
                    </p>
                    <p>The special issue of Social Psychology contains 15 papers, all of which are Registered Reports (RR) and all of which were designed to replicate important classic or contemporary results from social psychology.  According to Daniel Lakens, Assistant Professor at Eindhoven University of Technology and co-Editor of the special issue,  “This special issues demonstrates the viability of the Registered Reports model and also provides substantial evidence about a variety of important areas of research in social psychology.”
                    </p>
                    ...
                    <dl>
                        ...
                        <dd>
                            If the results of the original and replication differ, they are two data points for understanding the investigated effect.  Only rarely is a single study definitive.  Evidence for a phenomenon is a slow accumulation of results across a variety of approaches.  Differences among those results is fodder for researchers to better understand the effect in terms of when and how it occurs.  The replications in the special issue follow a variety of good practices to ensure that they are highly informative for understanding the reproducibility of the original results including: (a) high-powered tests (i.e., large samples) to minimize likelihood of false negatives, (b) pre-registration of design and analysis plans to maximize the quality and interpretability of the confirmatory research designs, (c) peer review prior to data collection to maximize the quality of the methodology, and (d) explicit discussion of differences between original design and replication to identify potential reasons for different results, or to illustrate the generalizability of the original effect for successful replications.
                        </dd>
                    </dl>
