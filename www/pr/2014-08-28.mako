    ...
    <div class="row">
        ...
        <div class="col-md-9 blog-item margin-bottom-40 ">
            ...
            <div style="padding-bottom: 50px;">
                <p>First announced in October 2013, with $1.3 million in funding from the Laura and John Arnold Foundation, <a href="https://osf.io/e81xl/wiki/home/">The Reproducibility Project: Cancer Biology</a> aims to replicate key experimental findings in <a href="https://osf.io/e81xl/wiki/studies/">50 high-profile pre-clinical cancer biology studies</a> published between 2010 and 2012. The articles were selected on the basis of their very high citation rates and other scores of online attention.</p>

                <p>The Reproducibility Project: Cancer Biology is conducted at a time when <a href="http://www.economist.com/news/briefing/21588057-scientists-think-science-self-correcting-alarming-degree-it-not-trouble">concerns have been expressed</a> about the reproducibility of biomedical research, and the <a href="http://www.nature.com/news/policy-nih-plans-to-enhance-reproducibility-1.14586">National Institutes of Health are calling for renewed efforts</a> to enhance reproducibility. The project will provide a substantial and unprecedented dataset on the reproducibility of a large body of high-profile cancer biology articles.</p>

                <p>“We need an objective way to evaluate reproducibility,” said Randy Schekman, Editor-in-chief of eLife and professor at the University of California at Berkeley. “This project is a valuable opportunity to generate a high-quality dataset to address questions about reproducibility constructively and rigorously.”</p>

                <p>Following on from similar studies in psychology, the replication studies in the cancer biology project are presented in two distinct phases. The first phase involves the production of a <a href="https://osf.io/8mpji/wiki/home/">Registered Report</a> – a novel publishing format that sets out how the replication study will be performed, the reagents and protocols, the sample sizes, and the planned analyses. The second phase is the Replication Study itself, which must be conducted as specified in the Registered Report and will be realised through the Science Exchange network of expert scientific labs. Both phases will be subject to eLife’s rigorous and consultative peer review process. Once the Replication Study is published, all methods and data, will be openly accessible on the <a href="http://osf.io">Open Science Framework</a> for the scientific community to view, critique, or extend.</p>

                <p>"We believe that independent investigation of experimental results is an important step for assessing breakthrough scientific results,” said Science Exchange CEO, Elizabeth Iorns. Timothy Errington, project manager at the Center for Open Science, agreed with Iorns, adding, “This project serves as a model to understand reproducibility challenges shared across scientific disciplines and to encourage openness in research practices.”</p>

                <p>Registered Reports are now under review by the eLife Board of reviewing editors and will be published in the eLife journal as available.</p>

                <p>For more information about the Reproducibility Project: Cancer Biology visit <a href="http://osf.io/e81xl/wiki">http://osf.io/e81xl/wiki.</a></p>
                ...
                +44 (0) 1223 855 373<br>
                <a href="mailto:j.mitchell@elifesciences.org" rel="nofollow">j.mitchell@elifesciences.org</a></p>

                <p>Andrew Sallans<br>
                Community, Partnerships, and Funding Manager, Center for Open Science<br>
