        ...
        return function(elementPrefix) {
            var sequence = Sequence({
                ...
                onInitializeMember: function(sequenceMember) {
                    ...
                    var available_block_types = ['centered_text','whitespaceblock','clear_fixblock','code_block','calender_blog','render_file','journal_block', 'customImage', 'calender_block', 'button'];
