...
//    });
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "static/css/themes/" + color + (isRTL ? '-rtl' : '') + ".css");
            $('#logoimg').attr("src", "static/img/logo_" + color + ".png");
            $('#rev-hint1').attr("src", "static/img/sliders/revolution/hint1-" + color + ".png");
            $('#rev-hint2').attr("src", "static/img/sliders/revolution/hint2-" + color + ".png");
        }
