...
class PersonModelAdmin(ModelAdmin):
    ...
    add_to_settings_menu = False  # or True to add model to Settings sub-menu
...
class JournalModelAdmin(ModelAdmin):
    ...
    list_display = ('title', 'is_registered_journal', 'is_featured_journal',
                    'is_special_journal', 'is_preregistered_journal',
                    'is_top_journal')
    list_filter = ('is_registered_journal', 'is_featured_journal',
                   'is_special_journal', 'is_preregistered_journal',
                   'is_top_journal')
    search_field = ('title',)
