# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-25 19:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_registered_journal', models.BooleanField()),
                ('is_special_journal', models.BooleanField()),
                ('is_featured_journal', models.BooleanField()),
                ('is_preregistered_journal', models.BooleanField()),
                ('is_eligible_journal', models.BooleanField()),
                ('additional', wagtail.wagtailcore.fields.StreamField((('publisher', wagtail.wagtailcore.blocks.CharBlock()), ('association', wagtail.wagtailcore.blocks.CharBlock()), ('area', wagtail.wagtailcore.blocks.CharBlock()), ('journal', wagtail.wagtailcore.blocks.RawHTMLBlock()), ('note', wagtail.wagtailcore.blocks.RawHTMLBlock())), blank=True, null=True)),
            ],
            options={
                'ordering': ['title'],
            },
